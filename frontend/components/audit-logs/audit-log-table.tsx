    ...
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        ...
        <tbody>
            ...
            <tr key={log.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
              ...
              <td className="py-3 px-4">
                <span className={`px-2 py-1 rounded text-xs font-bold ${
                  ...
                  log.action === 'DELETE' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'
                }`}>{log.action}</span>
              </td>
          ...
          {logs.length === 0 && <tr><td colSpan={5} className="py-4 text-center text-gray-500 dark:text-gray-400">No audit logs</td></tr>}
        </tbody>
      </table>
    </div>
  )
